...
plot(richness/sum(richness),type='l',xlab='Elevation',ylab="Relative Species Richness",ylim=c(0,0.07))
abline(v=which.max(richness),col='blue')
lines(x=1:25,y=rowSums(data[2:ncol(data)])/sum(rowSums(data[2:ncol(data)])),col='green')
```
