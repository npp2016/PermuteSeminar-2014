...
#make a output matrix to fill all the differentsimulations (why we have a third dimension, so that it does not replace the earlier matrix)
...
```{r}
#to get the original dataset values, the r and s values were recalcuated from the original dataset
